...
설정에서는 전체 커서 배율을 50–200%로 조절하거나 실행 중 Dock 아이콘을 숨길 수 있습니다. Dock 아이콘을 숨기면 메뉴 막대의 Momiji 아이콘에서 앱 열기·설정·종료를 사용할 수 있습니다. **로그인 후 계속 적용**을 직접 켠 경우에만 로그인 항목을 등록하고 로그인·절전 복귀·사용자 세션 활성화 시 활성 테마를 다시 적용합니다. 관리자 권한은 요구하지 않습니다.
